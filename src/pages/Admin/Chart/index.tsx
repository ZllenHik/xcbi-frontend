...
import CreateChartModal from '@/pages/Admin/Chart/component/CreateChartModal';
import UpdateChartModal from '@/pages/Admin/Chart/component/UpdateChartModal';

import { ActionType, PageContainer, ProColumns, ProTable } from '@ant-design/pro-components';
import { Button, Divider, message, Popconfirm, Space, Typography } from 'antd';
import React, { useRef, useState } from 'react';
import {deleteChartUsingPOST, listChartByPageUsingPOST} from "@/services/xcbi/chartController";
...
const AdminChartPage: React.FC<unknown> = () => {
  ...
  const param: ProColumns<API.Chart>[] = [
    {
      title: 'id',
      dataIndex: 'id',
      valueType: 'index',
